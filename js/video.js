...
VideoJS.options = {
  ...
  // defaultVolume: 0.85,
  defaultVolume: 0.5, // The freakin seaguls are driving me crazy!
...
if (CDN_VERSION != "GENERATED_CDN_VSN") {
  _V_.options.flash.swf = videoUrl.swfPlauer
}
...
_V_.TimeDisplay = _V_.Component.extend({
    ...
    createElement: function(){
    return _V_.createElement("div", {
      className: "vjs-controls-time vjs-time-controls vjs-control"
    });
  }
...
_V_.CurrentTimeDisplay = _V_.Component.extend({
  ...
  createElement: function(){
    var el = this.content = _V_.createElement("span", {
...
_V_.TimeBktOpen = _V_.Component.extend({

  createElement: function(){
    return this._super("span", {
      className: "vjs-time-bracket",
      innerHTML: '['
    });
  }

});
_V_.TimeBktClosed = _V_.Component.extend({
...
_V_.Poster = _V_.Button.extend({
  ...
  createElement: function(){
    return _V_.createElement("div", {
      className: "vjs-poster-wrap",
      // Don't want poster to be tabbable.
      tabIndex: -1,
      innerHTML: '<img class="vjs-poster" src='+this.player.options.poster+' />'
    });
  },
